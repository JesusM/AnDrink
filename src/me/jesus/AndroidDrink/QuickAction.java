...
public class QuickAction extends CustomPopupWindow {
	...
	private void createActionList(boolean b) {
		...
		for (int i = 0; i < actionList.size(); i++) {
			...
			if (b == true) {
				...
				view = getActionItem(title,  listener);
			}
	 ...
	 * @return
	 */
	private View getActionItem(String title, OnClickListener listener) {
		LinearLayout container = (LinearLayout) inflater.inflate(
				R.layout.action_item_without_image, null);
